      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Browse and analyze tokenized real-world assets (RWA) - stocks, bonds, and commodities on blockchain.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Browse tokenized asset listings</li>
            <li>Analyze underlying asset data</li>
            <li>Compare tokenization across platforms</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Comprehensive RWA asset database</li>
            <li>✓ Real-time token price tracking</li>
            <li>✓ Underlying asset information</li>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Review tokenization details</li>
            <li>Compare across platforms</li>
          </ol>
        </section>
